    ...
    public function map()
    {
        Route::group(['namespace' => $this->namespace], function (Router $router) {
            ...
            $router->group(['middleware' => 'api', 'prefix' => 'api'], function(Router $router) {
                ...
                $router->get('menulinks', 'MenulinksApiController@index')->name('api::index-menulinks');
                $router->put('menulinks/{menulink}', 'MenulinksApiController@update')->name('api::update-menulink');
