    ...
    public function map()
    {
        Route::namespace($this->namespace)->group(function (Router $router) {
            ...
            $router->middleware('admin')->prefix('admin')->group(function (Router $router) {
                ...
                $router->get('menus/{menu}/edit', [AdminController::class, 'edit'])->name('admin::edit-menu')->middleware('can:read menus');
                ...
                $router->get('menus/{menu}/menulinks/{menulink}/edit', [MenulinksAdminController::class, 'edit'])->name('admin::edit-menulink')->middleware('can:read menulinks');
